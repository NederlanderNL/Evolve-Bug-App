...
// Voting is intentionally open to anyone with the link — no passcode check.
// Duplicate-vote prevention is handled client-side (localStorage), not here.
// Accepts { type, previousType } so a vote can be switched (up<->down) or
// retracted (type: null) without ever letting the counts go negative.
